#Note: R Code was made on GitHub so all group members could access the code.
---
...
spotify <- read.csv(file="/Users/danielfragomeni/Library/CloudStorage/OneDrive-UniversityofToronto/spotify-2023.csv", header=T)
```
